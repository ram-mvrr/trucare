...
public class ClaimServiceImpl implements ClaimService {
    ...
    @Autowired
    public ClaimServiceImpl(ClaimRepository claimRepository, ClaimProducerService claimProducerService, KafkaTemplate kafkaTemplate, ClaimMapper claimMapper, MemberClient memberClient, ProviderClient providerClient, KafkaTemplate<String, Object> kafkaTemplate1) {
    ...
    public ClaimDTO createClaim(CreateClaimDTO createClaimDTO) {
        ...
        kafkaTemplate.send("document.upload", new DocumentUploadEvent(savedClaim.getClaimId(), createClaimDTO.getDocuments()));
